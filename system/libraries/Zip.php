...
class CI_Zip  {
	...
	function _add_dir($dir, $file_mtime, $file_mdate)
	{
		...
		$this->zipdata .=
			...
			.$dir
			// below is "files descriptor" segment
			.pack('V', 0) // crc32
			.pack('V', 0) // compressed filesize
			.pack('V', 0); // uncompressed filesize
	 ...
	 * @param	string	the files to be encoded
	 * @return	void
	 */
	 ...
	 * Initialize Data
	 *
	 * Lets you clear current zip files.  Useful if you need to create
	 * multiple zips with different files.
	 *
	 * @access	public
	 * @return	void
	 */
