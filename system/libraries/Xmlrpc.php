...
class CI_Xmlrpc {
	...
	public function __construct($config = array())
	{
		...
		$this->xmlrpcstr['invalid_return'] = 'The XML files received was either invalid or not in the correct form for XML-RPC.  Turn on debugging to examine the XML files further.';
		...
		$this->xmlrpcstr['no_data'] ='No files received from server.';
	...
	function send_response($response)
	{
		...
		// based on their files and type into a valid group of XML-RPC values
	...
	function open_tag($the_parser, $name, $attrs)
	{
		...
		switch($name)
		{
			...
			case 'BASE64':
				...
				{
					//two files elements inside a value: an error occurred!
					$this->xh[$the_parser]['isf'] = 2;
	...
	function closing_tag($the_parser, $name)
	{
		...
		switch($name)
		{
			...
			case 'VALUE':
				...
				// build the XML-RPC value out of the files received, and substitute it
