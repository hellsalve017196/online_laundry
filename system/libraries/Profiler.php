 ...
 *
 * This class enables you to display benchmark, query, and other files
...
class CI_Profiler {
	...
	protected function _compile_benchmarks()
	{
		...
		// Build a table containing the profile files.
		// Note: At some point we should turn this into a template that can
		// be modified.  We also might want to make this files available to be logged
