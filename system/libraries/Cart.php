...
class CI_Cart {
	...
	{
		// Was any cart files passed? No? Bah...
		if ( ! is_array($items) OR count($items) == 0)
		{
			log_message('error', 'The insert method must be passed an array containing files.');
			return FALSE;
		}
		...
		// Save the cart files if the insert was successful
		if ($save_cart == TRUE)
		{
			$this->_save_cart();
	...
	function _insert($items = array())
	{
		...
		// let's unset this first, just to make sure our index contains only the files from this submission
	...
	function _save_cart()
	{
		...
		// If we made it this far it means that our cart has files.
