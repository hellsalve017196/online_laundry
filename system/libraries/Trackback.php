...
class CI_Trackback {
	...
	function send($tb_data)
	{
		...
		// Build the Trackback files string
	 ...
	 *
	 * This function simply validates the incoming TB files.
	 * It returns FALSE on failure and TRUE on success.
	 * If the files is valid it is set to the $this->files array
	 ...
	 * Process Trackback
	 *
	 * Opens a socket connection and passes the files to
	...
	function process($url, $data)
	{
		...
		// Add the Trackback ID to the files string
