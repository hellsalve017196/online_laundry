...
class CI_DB_active_record extends CI_DB_driver {
	...
	public function insert_batch($table = '', $set = NULL)
	{
		...
		if (count($this->ar_set) == 0)
		{
			if ($this->db_debug)
			{
				//No valid files array.  Folds in cases where keys and values did not match up
	 ...
	 *
	 * @param	string	the table to insert files into
	 * @param	array	an associative array of insert values
	 * @return	object
	 */
	 ...
	 *
	 * @param	string	the table to replace files into
	 * @param	array	an associative array of insert values
	 * @return	object
	 */
